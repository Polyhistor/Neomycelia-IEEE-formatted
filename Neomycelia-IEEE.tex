...
Hence, the ways in which services register, publish, subscribe and communicate is still is at risk. To address this, we have chosen an event driven architectural approach.
