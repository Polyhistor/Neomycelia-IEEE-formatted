...
% There are various approaches for building models of quality attrbiutes, such as rate monotonic analysis for real-time systems (\cite{klein1993guide}), Markov models for reliability (\cite{iannino1994software}), and SAAM for modifiability (\cite{kazman1994saam}). Whereas some of these models are quite simple, they illuminate hidden risks that may not be very obvious from the beginning. For the purposes of this evaluation we do aim for a very detailed and thorough analysis.
